...
export const team = [
  {
    ...
    coverage: 'Written enquiries — finance@logoorbit.net',
    sections: [
      {
      ...
      },
      {
        ...
        table: [
          ['Who you contract with', 'LogoOrbit, a design brand operated by RevoluSys Inc. The terms you accept are ours and the work is ours.'],
    ...
    faqs: [
      {
        ...
        a: 'Because Phelps & Associates, LLC is the billing and merchant entity that issues the invoice and processes the payment. It is directed by Professor James Phelps, our Director and Chief Financial Officer. The charge is correct and it is ours — please write to finance@logoorbit.net before opening a bank dispute, and it will be identified for you the same way.',
      },
      {
        q: 'Who am I actually contracting with?',
        a: 'LogoOrbit, a design brand operated by RevoluSys Inc. Our terms and conditions govern the work, and the design and its ownership come from us. Phelps & Associates, LLC handles the billing side of that arrangement and is named on the invoice as such.',
      },
      {
