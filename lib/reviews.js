...
const reviewNotes = {
  ...
  'Rebecca Rowe': {
    ...
    note: [
      'The line doing the work here is the one about not having to chase anyone. This is the review of somebody who expected to buy a logo from one place, cards from another and a website from a third, and did not have to.',
