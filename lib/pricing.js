...
export const logoPackages = {
  ...
  items: [
    ...
    },
    {
      ...
      highlights: ['6 designs to choose from', 'Unlimited changes', 'Ready in 24 to 48 hours', 'You own the copyright'],
      features: [
        '6 Logo Concepts',
        'Unlimited Revisions',
        'Custom Logo',
...
export const videoPackages = {
  ...
  items: [
    ...
    },
    {
      ...
      featured: true,
      badge: 'Best value',
      bestFor: 'Channels and brands that post every week and want it all handled for one monthly price.',
      highlights: [
        '8 videos a month, edited',
        '20 shorts or reels cut from them',
        'Thumbnails for every upload',
        'A producer who knows your channel',
      ],
      features: [
        '8 long-form videos edited each month',
        '20 shorts, reels or TikToks cut from the same footage',
        'A thumbnail for every upload',
        'Branded intro, outro and lower thirds',
        'Sound mixing on every video',
        'Captions on everything',
        'Same editor every week',
        'Upload-ready files, on schedule',
        'Cancel any month',
      ],
    },
  ],
  compare: {
    columns: ['Starter Edit', 'YouTube Pro', 'Film and Ads', 'Channel Monthly'],
    rows: [
      { label: 'What you get', values: ['1 video', '1 video', '1 film', '8 videos a month'] },
      { label: 'Length', values: ['5 minutes', '15 minutes', 'Up to 3 minutes', 'No limit'] },
      { label: 'Thumbnails', values: ['1', '3', 'On request', 'One per video'] },
      { label: 'Shorts and reels', values: [false, false, true, '20 a month'] },
      { label: 'Intro and outro', values: [false, true, true, true] },
      { label: 'Sound design and mixing', values: ['Music only', true, true, true] },
      { label: 'Colour grading', values: [false, 'Correction', 'Cinematic', 'Correction'] },
      { label: 'Voice-over', values: [false, false, true, 'On request'] },
      { label: 'Rounds of changes', values: ['2', 'Unlimited', 'Unlimited', 'Unlimited'] },
    ],
  },
}
...
export const awardWinningPackage = {
  ...
  groups: [
    ...
    {
      title: 'Our Promise',
      items: ['100% Unique Design Guarantee', '100% Satisfaction Guarantee', 'Free consultation before you commit'],
    },
  ],
}
...
const _flagship = {
  ...
  includes: [
    { label: 'Platinum Logo, unlimited concepts, editable master files', price: 189 },
    { label: 'Ultimate Branding Kit, 16 branded items, cards to signage', price: 499 },
    { label: 'Gold Logo Animation, custom motion graphics with voice-over', price: 499 },
    { label: '5-page website, designed, built and launched', price: 699 },
    { label: '250 business cards printed and posted to you', price: 199 },
    { label: '3 social ad banners and a flyer design', price: 199 },
  ],
  reasons: [
...
export const brandProtection = {
  ...
  points: [
    ...
    'You keep full copyright of the design either way, registered or not',
  ],
  note: 'Our fee is $299 per class. The USPTO charges its own government filing fee on top, currently $350 per class, paid directly to them.',
}
  ...
  items: [
    {
      ...
      price: 99,
      from: true,
      body: 'We print and post the cards we designed for you. 100 cards $99, 250 cards $175, 500 cards $285, 1,000 cards $350.',
    },
    {
    ...
    },
    {
      ...
      price: 99,
      per: 'a month',
      body: 'Backups, updates, security patches and up to an hour of content changes every month.',
    },
    {
    ...
    {
      name: 'App care and updates',
      icon: 'mobile',
      price: 199,
      per: 'a month',
      body: 'OS updates, crash fixes, store re-submissions and up to two hours of small app changes every month.',
    },
    {
...
export const categories = [
  ...
  },
  {
    ...
    howToChoose:
      'Posting one video? Take a single edit. Posting every week? The monthly package works out cheaper than buying them one at a time.',
