...
export const salesTax = {
  ...
  short: 'Prices exclude California sales tax of 8.25%, added at invoice.',
  /** The fuller line, for a page that shows a total rather than a price. */
  long: 'All prices are shown before tax. California sales tax of 8.25% is added to the invoice where it applies.',
}
