...
export const testimonials = [
  {
    quote:
      "John sat down with me on the ideas side first which i honestly wasnt expecting, thought id just get sent a few files and thats that. Then had the final ones back the same day, few hours really. Cant fault it at all.",
    name: 'Rusk Jones',
    company: 'The Sealant Guys',
  },
  {
    quote:
      'Their logo maker is honestly great.. but the bit that sold me was getting the cards and the site done by the same people. Not chasing three seperate suppliers around was worth it on its own. Would recommend to anyone just starting out',
    name: 'Rebecca Rowe',
    company: 'Planticious',
  },
  {
    quote:
      'first time ive ever used one of these online logo tools so was a bit unsure going in. went really well though! thank you',
    name: 'Alan Mekinley',
    company: 'Battlefield',
  },
  {
    quote:
      "They put three different directions in front of us and we landed the final one after the first round of changes, no messing about. Turnaround was quicker than the lot we used before, wasn't even close.",
    name: 'Franklin D.',
    company: 'Northline Logistics',
  },
  {
    quote:
      'came in for just a logo and ended up leaving with the whole lot — brand system, website, social kit, everything. one team, one invoice, zero hassle. sound people to deal with',
    name: 'Guage M.',
    company: 'Guage Fitness',
  },
  {
    quote:
      "The team got what our market is actually about better than the agency we spoke to before them, and that lot wanted about ten times the money for it. Was patient with all my questions too and there was a lot of them, sorry! Highly recommend.",
    name: 'Rhonda Pierce',
    company: 'Bloom & Co.',
  },
]
