...
/**
 * WhatsApp is the quick lane. Anything that would otherwise sit in an inbox
 * for a morning, a price check, "is my file ready", a question before
 * ordering, gets answered on the same number the legal desk uses, so nobody
 * has to work out which thread to open.
 */
 ...
 * about design and starts being about rights, contracts or data.
 */
