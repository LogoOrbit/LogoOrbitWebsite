...
export const nav = [
  {
    ...
    href: '/portfolio',
    children: [
      { label: 'Logo work', href: '/portfolio#logos' },
      { label: 'Websites', href: '/portfolio#websites' },
      { label: 'Branding kits', href: '/portfolio#branding' },
      { label: 'Video and animation', href: '/portfolio#animation' },
    ],
  },
  {
    label: 'About',
  ...
  { label: 'Services', children: serviceNav },
  {
    ...
    href: '/brief',
    children: [
      { label: 'Logo and brand brief', href: '/brief#brief-form' },
      { label: 'Website brief', href: '/brief#brief-form' },
      { label: 'Video and YouTube brief', href: '/brief#brief-form' },
    ],
  },
  {
    label: 'Contact',
    ...
    children: [
      ...
      { label: 'Email us', href: 'mailto:legal@logoorbit.net' },
    ],
  },
]
...
export const services = [
  ...
  },
  {
    ...
    description:
      'We plan the screens, design them and build the app for both iPhone and Android, then help you get it into the stores.',
