export const site = {
  ...
  salesEmail: 'sales@logoorbit.net',
  ...
  years: 15,
  addresses: [
    'NexusForgeGroup, 8 The Green Ste A, Dover, Delaware, 19901',
    '244 5th Ave. Suite 22, New York, NY 10001',
    'Phelps & Associates, LLC (billing), 12332 Maplewood Dr., Lindale, TX 75771',
  ],
}
 ...
 *
 * LogoOrbit is the brand a client buys from; NexusForgeGroup is the company
 * that operates it and the one named in the terms as the counterparty. Kept
 * here rather than typed into each page so the two never drift apart, which
 * is exactly the sort of drift that makes a contract argument later.
 */
export const parentEntity = {
  name: 'NexusForgeGroup',
  address: '8 The Green Ste A, Dover, Delaware, 19901',
  registeredIn: 'Delaware',
  clientOffice: '244 5th Ave. Suite 22, New York, NY 10001',
}

/**
 * The entity that appears on the card statement.
 *
 * The name a customer reads on their bank line is very often not the name
 * above the shop door, and when those two do not match the honest reaction
 * is to assume fraud and call the bank. So the merchant of record is
 * published rather than left to be discovered: who it is, what it is, and
 * the descriptor to look for on the statement.
 *
 * Phelps & Associates, LLC is directed by Professor James Phelps, who is
 * also LogoOrbit's Director and Chief Financial Officer - which is why the
 * arrangement exists at all, and why the finance desk and the merchant
 * entity answer to the same person.
 */
export const billingEntity = {
  name: 'Phelps & Associates, LLC',
  site: 'https://phelps-llc.com/',
  address: '12332 Maplewood Dr., Lindale, TX 75771',
  phone: '+1-719-458-9996',
  descriptor: 'PHELPS & ASSOCIATES LLC',
  officer: 'Professor James Phelps',
  officerRole: 'Director & Chief Financial Officer',
  officerSlug: 'james-phelps',
  officerEmail: 'james@phelps-llc.com',
  blurb:
    'Invoices and card payments for LogoOrbit work are billed by Phelps & Associates, LLC, the merchant of record on the invoice. It is a professional education, training and academic writing company directed by Professor James Phelps, who is also our Director and Chief Financial Officer.',
}
...
/* Live chat configuration deliberately does NOT live in this file, and the
   reason is a trap worth leaving a sign on: further down, this module exports
   a constant named `process` - the four "how it works" steps - which shadows
   the Node global for every line in it. Anything reading
   `process.env.SOMETHING` here silently resolves against an array of copy
   blocks and the build dies while pre-rendering, pointing nowhere near the
   cause. Live chat is in lib/livechat.js for that reason. */
...
export const nav = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Mobile app brief', href: '/brief/app.html' },
      { label: 'Video and YouTube brief', href: '/brief/video' },
      { label: 'USPTO trademark brief', href: '/brief/trademark' },
    ],
  },
  {
    label: 'Contact',
...
export const testimonials = [
  {
    quote:
      'John helped me work out what i actually wanted then had the files over in a few hours. top man',
    name: 'Rusk Jones',
    company: 'The Sealant Guys',
  },
  {
    quote:
      'Logo, cards and the website all from the same team so i wasnt chasing anyone. Really happy with it',
    name: 'Rebecca Rowe',
    company: 'Planticious',
  },
  {
    quote:
      'first time using one of these online, went way better than i thought it would. cheers!',
    name: 'Alan Mekinley',
    company: 'Battlefield',
  },
  {
    quote:
      "Got 3 options, picked one, one round of changes and it was done. Quicker than anyone we've used before.",
    name: 'Franklin D.',
    company: 'Northline Logistics',
  },
  {
    quote:
      'came for a logo, ended up with the brand, site and socials lol. one invoice for the lot, no hassle',
    name: 'Guage M.',
    company: 'Guage Fitness',
  },
  {
    quote:
      'They got our market straight away. Agency quoted us 10x for pretty much the same thing, no brainer really',
    name: 'Rhonda Pierce',
    company: 'Bloom & Co.',
  },
]
