...
/**
 * Discipline name by id. A cart line reads better as "Print & Packaging" than
 * as "print", and the same label has to come out of any page that adds one.
 */
export const groupName = Object.fromEntries(serviceGroups.map((g) => [g.id, g.name]))
...
export const catalogServices = [
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'You do, and we set it up to be maintainable: documented decisions, named tokens and a contribution process. When it needs extending later, that is quoted as its own piece of work.',
      },
    ],
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Yes. Order a batch and the per-thumbnail price drops against buying them one at a time. It is a quoted batch, not a plan you are signed up to.',
      },
      {
  ...
  /* ------------------------------------------------------------ programmes */
  {
    ...
    related: ['brand-strategy', 'design-system', 'enterprise-branding', 'creative-consulting'],
