  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'No. Every price on the site is shown before tax, so the figure you compare against another studio is the figure for the work. California sales tax of 8.25% is added to the invoice where it applies, and you will see it as its own line rather than folded into the total. Charges we pass straight through, like a USPTO filing fee, are not marked up and are not taxed by us.',
      },
      {
        q: 'Are there hidden costs?',
        a: 'No. The price on the package is the price. The only things charged separately are ones we tell you about first: extra revision rounds on entry-level packages, government trademark fees paid to the USPTO, printing, domain or hosting renewals that go to the provider rather than to us, and sales tax where it applies.',
      },
      {
...
const detail = {
  ...
  'Are the designs original, or from a template library?': {
    metaTitle: 'Are Your Logo Designs Original?',
  ...
  'What is the difference between owning a logo and registering it?': {
    ...
    metaTitle: 'Owning a Logo vs Registering It',
    more: [
  ...
  'Who do I contact about privacy, contracts or an NDA?': {
    metaTitle: 'Privacy, Contracts and NDAs',
  ...
  'Do you publish apps to the App Store and Google Play?': {
    metaTitle: 'Do You Publish Apps to the App Stores?',
  ...
  'Can you make a small change later?': {
    ...
    more: [
      ...
      'We keep the master files, so a later change starts from the original artwork rather than from a copy of a copy. If you expect a run of changes, tell us what you have in mind and we will quote the batch rather than charging for each one.',
    ],
    links: [
      { name: 'Add-ons and extras', href: '/pricing#add-ons' },
      { name: 'Contact support', href: '/contact' },
    ],
  },
...
export const faqItems = faqGroups.flatMap((group) =>
  group.items.map((item) => {
    ...
    return {
      ...
      more: extra.more || [],
      links: extra.links || [],
      // Optional. Set only where the question is too long to survive a search
      // result once " | LogoOrbit" is appended to it - see the page component.
