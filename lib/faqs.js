  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Completely. Once the order is paid in full the copyright transfers to you in writing, and the editable source files come with it. There is no licence to renew and nothing else to pay us, ever.',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Send the details to our legal desk, with links or screenshots. Greg Adams, our Senior Legal Counsel, looks after brand protection and will tell you what your options actually are before anybody spends money on them.',
      },
      {
        q: 'Who do I contact about privacy, contracts or an NDA?',
        a: 'The same desk. Anything involving rights, data or a signature from our side goes to legal rather than to support, and it is answered by a named lawyer, normally within one working day.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        a: 'You get the full file pack, the written copyright transfer and a person you can still call. We do not close the door on a project the day it ships.',
      },
      {
