...
export const termsSections = [
  ...
  },
  {
    ...
    paragraphs: [
      'Invoices are issued by Phelps & Associates, LLC, 12332 Maplewood Dr., Lindale, TX 75771, which is the billing and merchant entity associated with the invoice. Its director, Professor James Phelps, is also LogoOrbit’s Director and Chief Financial Officer. This means the name on your card statement references Phelps & Associates, LLC rather than the LogoOrbit trading name — that is expected and it is not an error. If a charge looks unfamiliar, write to finance@logoorbit.net before opening a bank dispute and it will be identified for you in writing.',
