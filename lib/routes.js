...
const staticRoutes = [
  ...
  { path: '/offers', changefreq: 'weekly', priority: '0.9', lastmod: '2026-08-04' },
  { path: '/offers/informative-website', changefreq: 'weekly', priority: '0.8', lastmod: '2026-08-04' },
  { path: '/portfolio', changefreq: 'monthly', priority: '0.8' },
  // The three portfolio sections are indexable pages in their own right and
  // were simply missing from this list, so nothing declared them.
  { path: '/portfolio/logo-design', changefreq: 'monthly', priority: '0.8' },
  { path: '/portfolio/website-design', changefreq: 'monthly', priority: '0.8' },
  { path: '/portfolio/animation', changefreq: 'monthly', priority: '0.7' },
  ...
  { path: '/brief/trademark', changefreq: 'monthly', priority: '0.7' },
