  ...
  return (
    <div className="fixed right-4 bottom-24 lg:right-6 lg:bottom-6 z-40 flex flex-col items-end gap-3">
      ...
      <a
        ...
        className="group relative grid place-items-center w-15 h-15 rounded-full bg-gradient-to-br from-[#2fd66f] to-[#128c4a] text-white shadow-2xl shadow-[#128c4a]/40 animate-pulse-ring-wa transition-transform duration-300 hover:scale-110 active:scale-95"
      >
