...
export const Icons = {
  ...
  sound: (p) => (
    <Svg {...p}>
      ...
      <path d="M16.4 9.2a4 4 0 010 5.6" />
      <path d="M18.9 6.7a7.5 7.5 0 010 10.6" />
    </Svg>
  ),
  muted: (p) => (
    <Svg {...p}>
      <path d="M5 9.5h3.2L13 5.6v12.8L8.2 14.5H5z" />
      <path d="M16.5 10l4.5 4M21 10l-4.5 4" />
    </Svg>
  ),
  quote: (p) => (
    <Svg {...p}>
  ...
  chat: (p) => (
    <Svg {...p}>
      <path d="M20.5 12.4c0 4-3.8 7.2-8.5 7.2a9.9 9.9 0 01-2.8-.4l-5 1.6 1.6-4A6.8 6.8 0 013.5 12.4c0-4 3.8-7.2 8.5-7.2s8.5 3.2 8.5 7.2z" />
  ...
  cart: (p) => (
    <Svg {...p}>
      <path d="M2.8 4h2.6l2.2 10.4a1.8 1.8 0 001.8 1.4h7.6a1.8 1.8 0 001.8-1.4L20.4 7H6.2" />
      <circle cx="10" cy="19.4" r="1.5" />
      <circle cx="17.2" cy="19.4" r="1.5" />
    </Svg>
  ),
  trash: (p) => (
    <Svg {...p}>
      <path d="M4.5 6.6h15" />
      <path d="M9.4 6.6V4.8a1.3 1.3 0 011.3-1.3h2.6a1.3 1.3 0 011.3 1.3v1.8" />
      <path d="M6.4 6.6l.9 12a1.8 1.8 0 001.8 1.7h5.8a1.8 1.8 0 001.8-1.7l.9-12" />
    </Svg>
  ),
  receipt: (p) => (
    <Svg {...p}>
